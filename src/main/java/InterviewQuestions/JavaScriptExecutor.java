...
//Complete JavaScript activities are wrote as Function
...
WebDriver driver;
	...
	public void framehandle(){
	    ...
	    WebElement loginBtn = driver.findElement(By.xpath("//input[@value ='Login']")); //login button
		//flash(loginBtn, driver); //highlight the element
		drawBorder(loginBtn, driver);
		generateAlert(driver, "Generate Alert");
	}
	
	//Following method will highlight the web element using Javascript 
